...
@Suite struct LocalControlTests {
    @Test func requestAndResponseOverAUnixSocket() async throws {
        let dir = FileManager.default.temporaryDirectory.appendingPathComponent("owndesk-lc-\(UUID().uuidString)", isDirectory: true)
    ...
    @Test func fileBackedIdentityPersists() throws {
        let dir = FileManager.default.temporaryDirectory.appendingPathComponent("owndesk-id-\(UUID().uuidString)", isDirectory: true)
